...
describe("Tab", () => {
  ...
  it("should be keyboard navigable", () => {
    expect(screen.getByText("Tab 1 title")).toHaveAttribute(
      "aria-selected",
      "true"
    );
    expect(screen.getByText("Tab 1 content").parentElement).toHaveAttribute(
      "aria-hidden",
      "false"
    );
    ...
    expect(screen.getByText("Tab 2 title")).toHaveAttribute(
      "aria-selected",
      "true"
    );
    expect(screen.getByText("Tab 2 content").parentElement).toHaveAttribute(
      "aria-hidden",
      "false"
    );
    ...
    expect(screen.getByText("Tab 3 title")).toHaveAttribute(
      "aria-selected",
      "true"
    );
    expect(screen.getByText("Tab 3 content").parentElement).toHaveAttribute(
      "aria-hidden",
      "false"
    );
