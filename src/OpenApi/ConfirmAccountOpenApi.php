...
class ConfirmAccountOpenApi implements OpenApiFactoryInterface {
    const OPERATION_PATH = "/api/users/{id}/confirm_account";
    ...
    public function __invoke(array $context = []): OpenApi {
        ...
        $openApi->getPaths()->addPath(self::OPERATION_PATH, $pathItem->withPost(
            ...
            ->withDescription("")
            ->withRequestBody(
                new Model\RequestBody("The confirmation token generated when the User created its account. It has been sent by mail.", new \ArrayObject(["application/ld+json" => ["schema" => ["type" => "string", "example" => ["token" => "string"]]]]), true)
            )->withResponses([
