...
{
    public const OPERATION_PATH = '/api/users/reset_password';
            ...
            $operation
                ...
                ->withRequestBody(
                    new Model\RequestBody(
                        'The new password to set to the User and the hashed token generated
                        when the User requested to reset his password',
                        new \ArrayObject(
                            [
                                'application/ld+json' => [
                                    'schema' => [
