...
export function Toast({ data, position, autoDeleteTimeout, deleteToast }: Props) {
    ...
    return <div
        ...
        className={`toast toast--${data.type} toast--${position} toast--${position}-${isVisible ? "enter" : "leave"}`}
    >
        <button className="toast__close" onClick={clearToast}><Icon name="close" /></button>
